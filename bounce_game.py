...
App = Tk()
App.title("Bounce_Game")
App.geometry("500x570")
App.resizable(0, 0)
App.wm_attributes("-topmost", 1)
canvas = Canvas(App, width=500, height=500, bd=0, highlightthickness=0, highlightbackground="Red", bg="Black")
...
App.bind_all("<Return>", start_game)
